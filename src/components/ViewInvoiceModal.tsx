    ...
    try {
      ...
      if (!error && invoiceData) {
        ...
        setCurrentInvoice({
          ...
          client: data["Client"],
          transportTitle: data["Titre de transport"],
          numero: data["numero"],
                  ...
                  <div className="p-4">
                    ...
                    <table className="w-full">
                      <tbody className="divide-y divide-gray-200">
                        ...
                        <tr>
                          <td className="py-2 text-xs text-gray-600 font-medium">Client:</td>
                          <td className="py-2 text-xs font-semibold text-gray-900">{currentInvoice.client || '-'}</td>
                        </tr>
                        <tr>
                          <td className="py-2 text-xs text-gray-600 font-medium">Titre de transport:</td>
                          <td className="py-2 text-xs font-semibold text-gray-900">{currentInvoice.transportTitle || '-'}</td>
                        </tr>
                        <tr>
                          <td className="py-2 text-xs text-gray-600 font-medium">Numéro:</td>
                          <td className="py-2 text-xs font-semibold text-gray-900">{currentInvoice.numero || '-'}</td>
                        </tr>
